cask "tether" do
  ...
  app "Tether.app"
  # The CLI ships inside the bundle; symlink it onto PATH as `tether` so the
  # app is self-contained (no separate formula needed).
  binary "#{appdir}/Tether.app/Contents/MacOS/tether-cli", target: "tether"
  ...
  postflight do
    cli = "#{appdir}/Tether.app/Contents/MacOS/tether-cli"
